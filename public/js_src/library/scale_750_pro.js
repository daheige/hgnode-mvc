...
(function (doc, win) {
    var ismobile = navigator.userAgent.match(/iphone|ipod|ipad|android/gi),
        ...
        dpr = ismobile && typeof dRatio != 'undefined' ? Math.min(dRatio, 3) : typeof dRatio != 'undefined' ? dRatio : 1,
    ...
    function createViewport() {
        ...
        metaEl.setAttribute('content', 'width=device-width,initial-scale=' + 1 / dpr + ',maximum-scale=1,minimum-scale=' + 1 / dpr + ',user-scalable=no');
